...
module RecordingStudioSitemaps
  module Generators
    # Generator to install RecordingStudioSitemaps migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio_sitemaps:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy RecordingStudioSitemaps migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in RecordingStudioSitemaps engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_sitemaps_pages.rb")
