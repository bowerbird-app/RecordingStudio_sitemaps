...
1. Review config/initializers/recording_studio_sitemaps.rb and set any required options.
2. If you use environment-specific settings, create config/recording_studio_sitemaps.yml.
3. Install the engine migrations with `bin/rails generate recording_studio_sitemaps:migrations`.
