...
class RecordingStudioHostTest < ActiveSupport::TestCase
  ...
  test "workspace opts into accessible without enabling it globally" do
    ...
    refute File.exist?(RecordingStudioSitemaps::Engine.root.join("lib/recording_studio_sitemaps/capabilities/example.rb"))
