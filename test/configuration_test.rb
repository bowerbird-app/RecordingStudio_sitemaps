...
class ConfigurationTest < Minitest::Test
  ...
  def test_initialize_uses_environment_api_key_and_defaults
    previous_value = ENV.fetch("RECORDING_STUDIO_SITEMAPS_API_KEY", nil)
    ENV["RECORDING_STUDIO_SITEMAPS_API_KEY"] = "env-token"
    ...
    ENV["RECORDING_STUDIO_SITEMAPS_API_KEY"] = previous_value
  end
